...
//Connects to Mongodb instance on Atles
 const MONGODB_URI = 'mongodb+srv://fruge:frugedatabase@frugedatabase.4krmx.mongodb.net/test?retryWrites=true&w=majority';
const option =  {
...
mongoose.connect(MONGODB_URI, option, (err) => {
    if (err){
        ...
        console.log("Connection to FruGe Database is ready");
    }
});
